...
class mcp_ban
{
	...
	function main($id, $mode)
	{
		...
		{
			include($engine_root_path . 'includes/acp/acp_ban.' . $phpEx);
		}
		...
		*/
		...
		extract($engine_dispatcher->trigger_event('core.mcp_ban_main', compact($vars)));
			...
			if ($ban)
			{
				if (confirm_box(true))
				{
					...
					*/
					...
					extract($engine_dispatcher->trigger_event('core.mcp_ban_before', compact($vars)));
					...
					*/
					...
					extract($engine_dispatcher->trigger_event('core.mcp_ban_after', compact($vars)));
				...
				else
				{
					...
					*/
					...
					extract($engine_dispatcher->trigger_event('core.mcp_ban_confirm', compact($vars)));
		...
		$template->assign_vars(array(
			...
			'U_FIND_USERNAME'	=> append_sid("{$engine_root_path}memberlist.$phpEx", 'mode=searchuser&amp;form=mcp_ban&amp;field=ban'),
		));
