...
class ucp_resend
{
	...
	function main($id, $mode)
	{
		...
		if ($submit)
		{
			...
			$message .= '<br /><br />' . sprintf($user->lang['RETURN_INDEX'], '<a href="' . append_sid("{$engine_root_path}index.$phpEx") . '">', '</a>');
		...
		$template->assign_vars(array(
			'USERNAME'			=> $username,
			'EMAIL'				=> $email,
			'S_PROFILE_ACTION'	=> append_sid($engine_root_path . 'ucp.' . $phpEx, 'mode=resend_act'))
		);
