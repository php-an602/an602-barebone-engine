...
function send_file_to_browser($attachment, $upload_dir, $category)
{
	...
	*/
	...
	if (!set_modified_headers($attachment['filetime'], $user->browser))
	{
		...
		if (defined('ENGINE_ENABLE_X_ACCEL_REDIRECT') && ENGINE_ENABLE_X_ACCEL_REDIRECT)
		{
		...
		else if (defined('ENGINE_ENABLE_X_SENDFILE') && ENGINE_ENABLE_X_SENDFILE && !phpbb_http_byte_range($size))
		{
