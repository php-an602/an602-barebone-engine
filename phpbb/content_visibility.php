...
class content_visibility
{
	...
	*/
	public function __construct(\phpbb\auth\auth $auth, \phpbb\config\config $config, \phpbb\event\dispatcher_interface $engine_dispatcher, \phpbb\db\driver\driver_interface $db, \phpbb\user $user, $engine_root_path, $php_ext, $forums_table, $posts_table, $topics_table, $users_table)
	{
		$this->auth = $auth;
		$this->config = $config;
