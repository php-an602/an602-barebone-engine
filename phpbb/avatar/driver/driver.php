...
abstract class driver implements \phpbb\avatar\driver\driver_interface
{
	...
	*/
	public function __construct(\phpbb\config\config $config, \FastImageSize\FastImageSize $imagesize, $engine_root_path, $php_ext, \phpbb\path_helper $path_helper, \phpbb\cache\driver\driver_interface $cache = null)
	{
		$this->config = $config;
