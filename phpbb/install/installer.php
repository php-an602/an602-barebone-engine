	...
	public function run()
	{
		...
		try
		{
			...
			else
			{
				...
				$engine_root_path = $this->container_factory->get_parameter('core.root_path');

				$acp_url = append_sid($engine_root_path . 'adm/index.php', 'i=acp_help_phpbb&mode=help_phpbb', true, $user->session_id);
