...
';
		...
		if (!empty($config_data))
		{
			if ($this->dbal_connection === null)
			{
				...
				$this->dbal_connection->sql_connect(
					...
					false,
					defined('ENGINE_DB_NEW_LINK') && ENGINE_DB_NEW_LINK
				);
			}
	 ...
	 *
	 * Only the parameters starting with "ENGINE__" are considered.
	 *
	...
	{
		return $this->environment ?: ENGINE_ENVIRONMENT;
	}
