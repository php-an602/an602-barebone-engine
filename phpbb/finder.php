...
class finder
{
	...
	*                           _ext_finder
	*/
	public function __construct(\phpbb\filesystem\filesystem_interface $filesystem, $engine_root_path = '', \phpbb\cache\service $cache = null, $php_ext = 'php', $cache_name = '_ext_finder')
	{
