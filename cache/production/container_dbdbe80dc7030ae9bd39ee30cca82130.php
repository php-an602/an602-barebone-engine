...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'engine_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../', 'php', 'engine_forums', 'engine_posts', 'engine_topics', 'engine_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('engine_captcha_questions', 'engine_captcha_answers', 'engine_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'engine_ext', './../', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'engine_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './../', 'php', 'engine_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_bbcodes', 'engine_smilies', 'engine_styles', 'engine_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'engine_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'engine_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'engine_acl_groups',
            'tables.acl_options' => 'engine_acl_options',
            'tables.acl_roles' => 'engine_acl_roles',
            'tables.acl_roles_data' => 'engine_acl_roles_data',
            'tables.acl_users' => 'engine_acl_users',
            'tables.attachments' => 'engine_attachments',
            'tables.auth_provider_oauth_token_storage' => 'engine_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'engine_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'engine_oauth_accounts',
            'tables.banlist' => 'engine_banlist',
            'tables.bbcodes' => 'engine_bbcodes',
            'tables.bookmarks' => 'engine_bookmarks',
            'tables.bots' => 'engine_bots',
            'tables.captcha_qa_questions' => 'engine_captcha_questions',
            'tables.captcha_qa_answers' => 'engine_captcha_answers',
            'tables.captcha_qa_confirm' => 'engine_qa_confirm',
            'tables.config' => 'engine_config',
            'tables.config_text' => 'engine_config_text',
            'tables.confirm' => 'engine_confirm',
            'tables.disallow' => 'engine_disallow',
            'tables.drafts' => 'engine_drafts',
            'tables.ext' => 'engine_ext',
            'tables.extensions' => 'engine_extensions',
            'tables.extension_groups' => 'engine_extension_groups',
            'tables.forums' => 'engine_forums',
            'tables.forums_access' => 'engine_forums_access',
            'tables.forums_track' => 'engine_forums_track',
            'tables.forums_watch' => 'engine_forums_watch',
            'tables.groups' => 'engine_groups',
            'tables.icons' => 'engine_icons',
            'tables.lang' => 'engine_lang',
            'tables.log' => 'engine_log',
            'tables.login_attempts' => 'engine_login_attempts',
            'tables.migrations' => 'engine_migrations',
            'tables.moderator_cache' => 'engine_moderator_cache',
            'tables.modules' => 'engine_modules',
            'tables.notification_emails' => 'engine_notification_emails',
            'tables.notification_types' => 'engine_notification_types',
            'tables.notifications' => 'engine_notifications',
            'tables.poll_options' => 'engine_poll_options',
            'tables.poll_votes' => 'engine_poll_votes',
            'tables.posts' => 'engine_posts',
            'tables.privmsgs' => 'engine_privmsgs',
            'tables.privmsgs_folder' => 'engine_privmsgs_folder',
            'tables.privmsgs_rules' => 'engine_privmsgs_rules',
            'tables.privmsgs_to' => 'engine_privmsgs_to',
            'tables.profile_fields' => 'engine_profile_fields',
            'tables.profile_fields_data' => 'engine_profile_fields_data',
            'tables.profile_fields_options_language' => 'engine_profile_fields_lang',
            'tables.profile_fields_language' => 'engine_profile_lang',
            'tables.ranks' => 'engine_ranks',
            'tables.reports' => 'engine_reports',
            'tables.reports_reasons' => 'engine_reports_reasons',
            'tables.search_results' => 'engine_search_results',
            'tables.search_wordlist' => 'engine_search_wordlist',
            'tables.search_wordmatch' => 'engine_search_wordmatch',
            'tables.sessions' => 'engine_sessions',
            'tables.sessions_keys' => 'engine_sessions_keys',
            'tables.sitelist' => 'engine_sitelist',
            'tables.smilies' => 'engine_smilies',
            'tables.sphinx' => 'engine_sphinx',
            'tables.styles' => 'engine_styles',
            'tables.styles_template' => 'engine_styles_template',
            'tables.styles_template_data' => 'engine_styles_template_data',
            'tables.styles_theme' => 'engine_styles_theme',
            'tables.styles_imageset' => 'engine_styles_imageset',
            'tables.styles_imageset_data' => 'engine_styles_imageset_data',
            'tables.teampage' => 'engine_teampage',
            'tables.topics' => 'engine_topics',
            'tables.topics_posted' => 'engine_topics_posted',
            'tables.topics_track' => 'engine_topics_track',
            'tables.topics_watch' => 'engine_topics_watch',
            'tables.user_group' => 'engine_user_group',
            'tables.user_notifications' => 'engine_user_notifications',
            'tables.users' => 'engine_users',
            'tables.warnings' => 'engine_warnings',
            'tables.words' => 'engine_words',
            'tables.zebra' => 'engine_zebra',
            ...
            'tables' => [
                'acl_groups' => 'engine_acl_groups',
                'acl_options' => 'engine_acl_options',
                'acl_roles' => 'engine_acl_roles',
                'acl_roles_data' => 'engine_acl_roles_data',
                'acl_users' => 'engine_acl_users',
                'attachments' => 'engine_attachments',
                'auth_provider_oauth_token_storage' => 'engine_oauth_tokens',
                'auth_provider_oauth_states' => 'engine_oauth_states',
                'auth_provider_oauth_account_assoc' => 'engine_oauth_accounts',
                'banlist' => 'engine_banlist',
                'bbcodes' => 'engine_bbcodes',
                'bookmarks' => 'engine_bookmarks',
                'bots' => 'engine_bots',
                'captcha_qa_questions' => 'engine_captcha_questions',
                'captcha_qa_answers' => 'engine_captcha_answers',
                'captcha_qa_confirm' => 'engine_qa_confirm',
                'config' => 'engine_config',
                'config_text' => 'engine_config_text',
                'confirm' => 'engine_confirm',
                'disallow' => 'engine_disallow',
                'drafts' => 'engine_drafts',
                'ext' => 'engine_ext',
                'extensions' => 'engine_extensions',
                'extension_groups' => 'engine_extension_groups',
                'forums' => 'engine_forums',
                'forums_access' => 'engine_forums_access',
                'forums_track' => 'engine_forums_track',
                'forums_watch' => 'engine_forums_watch',
                'groups' => 'engine_groups',
                'icons' => 'engine_icons',
                'lang' => 'engine_lang',
                'log' => 'engine_log',
                'login_attempts' => 'engine_login_attempts',
                'migrations' => 'engine_migrations',
                'moderator_cache' => 'engine_moderator_cache',
                'modules' => 'engine_modules',
                'notification_emails' => 'engine_notification_emails',
                'notification_types' => 'engine_notification_types',
                'notifications' => 'engine_notifications',
                'poll_options' => 'engine_poll_options',
                'poll_votes' => 'engine_poll_votes',
                'posts' => 'engine_posts',
                'privmsgs' => 'engine_privmsgs',
                'privmsgs_folder' => 'engine_privmsgs_folder',
                'privmsgs_rules' => 'engine_privmsgs_rules',
                'privmsgs_to' => 'engine_privmsgs_to',
                'profile_fields' => 'engine_profile_fields',
                'profile_fields_data' => 'engine_profile_fields_data',
                'profile_fields_options_language' => 'engine_profile_fields_lang',
                'profile_fields_language' => 'engine_profile_lang',
                'ranks' => 'engine_ranks',
                'reports' => 'engine_reports',
                'reports_reasons' => 'engine_reports_reasons',
                'search_results' => 'engine_search_results',
                'search_wordlist' => 'engine_search_wordlist',
                'search_wordmatch' => 'engine_search_wordmatch',
                'sessions' => 'engine_sessions',
                'sessions_keys' => 'engine_sessions_keys',
                'sitelist' => 'engine_sitelist',
                'smilies' => 'engine_smilies',
                'sphinx' => 'engine_sphinx',
                'styles' => 'engine_styles',
                'styles_template' => 'engine_styles_template',
                'styles_template_data' => 'engine_styles_template_data',
                'styles_theme' => 'engine_styles_theme',
                'styles_imageset' => 'engine_styles_imageset',
                'styles_imageset_data' => 'engine_styles_imageset_data',
                'teampage' => 'engine_teampage',
                'topics' => 'engine_topics',
                'topics_posted' => 'engine_topics_posted',
                'topics_track' => 'engine_topics_track',
                'topics_watch' => 'engine_topics_watch',
                'user_group' => 'engine_user_group',
                'user_notifications' => 'engine_user_notifications',
                'users' => 'engine_users',
